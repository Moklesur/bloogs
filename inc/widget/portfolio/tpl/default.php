<div class="bloogs-portfoilo <?php echo $instance['heading_alignment']; ?>">
	...
	<?php foreach( $instance['portfolio'] as $i => $portfolio ) : ?>
		<div class="bloogs-portfolio-list  position-relative padding-null col-md-<?php echo esc_attr( $instance['per_row'] ); ?> col-sm-<?php echo esc_attr( $instance['per_row'] ); ?> col-xs-6">
			<?php
